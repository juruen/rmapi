...
```bash
curl -L  https://github.com/juruen/rmapi/releases/download/v0.0.12/rmapi-macosx.zip -o rmapi.zip -o rmapi.zip -o rmapi.zip -o rmapi.zip -o rmapi.zip -o rmapi.zip
```
